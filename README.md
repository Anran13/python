...
# Deep Learning and Image Recognition
  ...
  5. Execute the following command in **Arduino IDE**
     ```
     ...
     // ------ 以下修改成你MQTT設定 ------
     const char* mqtt_server = "mqttgo.io";//免註冊MQTT伺服器
     const unsigned int mqtt_port = 1883;
     #define MQTT_USER               ""             //本案例未使用
     #define MQTT_PASSWORD           ""         //本案例未使用
     #define MQTT_PUBLISH_Monitor    "myvideo"  // 放置Binary JPG Image的Topoc，記得要改成自己的
